...
import { DeleteSelectedButtonLogs } from "@/app/(dashboard)/_components/jsx/logs/audit_logs/delete_selected_button";
import { FlushLogsButton } from "@/app/(dashboard)/_components/jsx/logs/audit_logs/flush_records_button";
...
const Page = () => {
  ...
  const t = useTranslations('dashboard.logs.audit_logs')
  ...
  const baseUrl = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/staff/log/audit_logs/`
                  ...
                  {data.map((obj) => (
                    <div className="card mb-3 shadow-sm" key={`card_${obj?.id}`}>
                      <div className="card-body">
                        ...
                        <div className="mb-1">
                          <strong>{t('ip_address')} :</strong> {obj?.ip_address}
                        </div>
                        <div className="mb-1">
                          <strong>{t('Action')} :</strong> {obj?.action_type}
                        </div>
                        <div className="mb-1">
                          <strong>{t('DB_Table')} :</strong> {obj?.model_name}
                        </div>
                        <div className="mb-1">
                          <strong>{t('Record_ID')} :</strong> #{formatNumber(obj?.object_id)}
                        </div>
                        <div className="mb-1">
                          <strong>{t('Hint_Info')} :</strong> {obj?.object_description}
                        </div>
                        <div className="mb-1">
