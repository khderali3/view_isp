...
export const DeleteButton = ({projectflow_id, item_id, handleReloadFlag=null}) => {
  ...
  const handleDelete = async () => {
	...
	try{
		...
		const response = await customFetch({
		   url: `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/staff/projectflow/projectflow/${projectflow_id}/installed_product/${item_id}/`,
		   method: 'DELETE',  
		   headers: {
