...
export const  StepOrSubStepNotes = ({notes=[], notes_for="step", step_or_step_id=null, can_add_note=false}) => {
    ...
    const url = notes_for === "step" 
        ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/site/projectflow/projectflow/step/${step_or_step_id}/note/`
        : `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/site/projectflow/projectflow/step/sub_step/${step_or_step_id}/note/` 
